...
// ── Config ────────────────────────────────────────────────────
const BASE = '<?= BASE_URL ?>';
const API_LIVE    = BASE + '/dealer/api/dsr-tracking/live';
const API_HISTORY = BASE + '/dealer/api/dsr-tracking/history';
...
const storedProvider = localStorage.getItem('dealer_dsr_tracking_map_provider') || 'osm';
setMapProvider('all', storedProvider);

function setMapProvider(mapType, providerKey) {
  localStorage.setItem('dealer_dsr_tracking_map_provider', providerKey);
