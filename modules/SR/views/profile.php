...
<div style="padding:16px;">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:20px;">
    <div style="background:#fff;border-radius:14px;padding:16px;box-shadow:0 2px 12px rgba(0,0,0,.06);text-align:center;">
      <i class="fa-solid fa-file-invoice" style="font-size:1.5rem;color:#2563eb;margin-bottom:6px;display:block;"></i>
  ...
  <div style="background:#fff;border-radius:14px;padding:24px;box-shadow:0 2px 12px rgba(0,0,0,.06);text-align:center;margin-bottom:16px;">
    ...
    <div style="display:inline-flex;align-items:center;gap:6px;background:rgba(37,99,235,.1);color:#2563eb;padding:6px 16px;border-radius:999px;font-size:0.8rem;font-weight:600;margin-top:14px;">
