...
<div class="min-h-screen bg-slate-100 flex items-center justify-center p-4">
  <div class="max-w-md w-full bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden p-8">
    ...
    <div class="text-center mb-8">
      ...
      <p class="text-xs text-slate-500 mt-1 font-medium">Admin Portal Sign In</p>
    </div>
    ...
    <form action="<?= url('admin/login') ?>" method="POST" class="space-y-4">
      ...
      <div>
        ...
        <input type="text" name="email" required placeholder="admin@happybd.com" 
      ...
      <div class="flex items-center gap-2 mt-1">
        <input type="checkbox" name="remember" value="1" id="remember_admin"
               class="w-4 h-4 text-blue-600 border-slate-300 rounded focus:ring-blue-500 cursor-pointer">
        <label for="remember_admin" class="text-xs text-slate-600 font-medium cursor-pointer select-none">Remember me for 30 days</label>
      </div>
